...
---
# MOC — Automation & Code
**Your existing edge — port it in week 1:** openpyxl chart-generation (40-intersection volume charts), S4A crash-cleaning scripts, Overpass/OSM query patterns, ArcGIS REST pulls, KMZ parsing. Each becomes a [[T - Code Script]] note with run instructions + a verified-against-manual date.
