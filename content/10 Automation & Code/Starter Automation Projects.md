...
---
# Starter Automation Projects (each = a [[T - Code Script]] note when shipped)
...
10. **Comp-sites database:** [[T - Comparable Site]] frontmatter → searchable table (Dataview does v1 free).
