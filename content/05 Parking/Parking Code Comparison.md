...
**Example application:** urban infill mixed-use — CBD overlay exempts retail minimums while base code doesn't; catching the overlay is the whole ballgame. Overlays, PDs, and TOD districts override base tables — search the code for them every time.
**Cross-links:** [[Workflow - Parking Study]] · agency notes `03 Agencies`
**Practice question:** code says "1 per 250 SF" — three questions you must answer before multiplying anything.
**QA/QC reminder:** ratio quoted with section number and measurement basis, from the CURRENT code (municode/agency site, dated).
