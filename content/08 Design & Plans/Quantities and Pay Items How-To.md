...
**Estimate:** BOE historical costs as sanity band; flag items outside band with reason.
**Practice question:** 6 thermoplastic left-arrows + 275 ft of 6" white skip + 2 stop bars 24"×12 ft — write the item list with units before looking anything up, then verify.
**QA/QC reminder:** every quantity has a shown calc and a second method or second person; "from CAD measure" alone isn't a check.
