...
**Outputs:** node results, travel times, queue counters; animation is persuasion, numbers are evidence.
**Beginner mistakes:** default driving behavior everywhere · single seed run · connectors starving flow · "calibrated" = "looks right."
**Free companions:** [FHWA Traffic Analysis Toolbox](https://ops.fhwa.dot.gov/trafficanalysistools/) — Volume III (2019 update) is the standard reference for the calibration/validation criteria flagged above; reviewers cite its acceptance thresholds when checking simulation work, and it ships with five short instructional videos.

**See also:** [[MOC - Software]] · [[Synchro QAQC Checklist]] · [[Cube and Travel Demand Models]]
