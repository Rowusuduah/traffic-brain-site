...
**Version control:** date-suffixed saves + a changelog cell; VBA/macros documented in [[T - Code Script]] notes; you already automate via openpyxl — decide per task: formulas (reviewer-transparent) vs Python (scale) and note the choice.
