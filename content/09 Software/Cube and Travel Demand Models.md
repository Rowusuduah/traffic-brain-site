...
**Concepts to hold:** TAZs · trip tables · 4-step chain · assignment & V/C plots · model validation limits (a regional model is not a TIA microscope — say so when reviewers over-trust it).
**Spawn when a modeling task lands:** network/zone editing note · matrix ops · scenario compare workflow.

**See also:** [[MOC - Software]] · [[Workflow - TIA from Request to Submittal]] · [[Vissim Basics]]
