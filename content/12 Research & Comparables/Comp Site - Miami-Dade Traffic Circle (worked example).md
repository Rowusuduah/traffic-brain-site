...
**Key design features:** [circle diameter, splitter/approach treatment, YIELD signing/markings per MUTCD, landscaping & maintenance agreement — pull from county standard detail].
**Before/after:** [cite county evaluation if published; else "program-level effectiveness cited by county — request data"] — never fill this from memory.
**Photos/maps:** [Google Earth pin + historical imagery pair].
**Sources & classes:** county program page (1) · standard detail (1) · council/committee item approving installs (1) · news coverage (7 — context only).
**Why comparable (to a Tampa-area local-street request):** matches roadway type/context/problem; differs on [agency criteria — Hillsborough's program scoring vs Miami-Dade petition thresholds] → address the delta explicitly in the memo.
